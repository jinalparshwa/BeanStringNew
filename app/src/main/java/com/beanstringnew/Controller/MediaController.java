...
public class MediaController {
    ...
    public static String path_value = "";
    ...
    public boolean convertVideo(final String path) {
        ...
        File cacheFile = new File(
                Environment.getExternalStorageDirectory()
                        + File.separator
                        + Configr.VIDEO_COMPRESSOR_APPLICATION_DIR_NAME
                        + Configr.VIDEO_COMPRESSOR_COMPRESSED_VIDEOS_DIR,
                "VIDEO_" + new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.US).format(new Date()) + ".mp4"
        );
        path_value = cacheFile.getAbsolutePath();
        Log.e("Path_value", path_value);
        String loadname = cacheFile.getName();
        name = loadname.substring(0, loadname.lastIndexOf("."));
