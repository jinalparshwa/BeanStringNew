...
public class Page_guidelines extends AppCompatActivity implements Thread.UncaughtExceptionHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_guidelines);
        ...
        txt_page_guideline = (TextView) findViewById(R.id.txt_page_guideline);

        imageView = (ImageView) findViewById(R.id.imageView);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Page_guidelines.this, Home_Social.class);
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Page_guidelines.this, Notification_activity.class);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Page_guidelines.this, Search_activity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        drawer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Page_guidelines.this, My_profile_activity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        llmybean.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Page_guidelines.this, My_Beans_Activity_new.class);
                startActivity(intent);
                finish();
            }
        });
        Myapplication.getInstance().trackScreenView("Page Guidelines Screen");
        beans_Count();
                ...
                try {
                    ...
                    if (res_flag.equals("200")) {
                        ...
                        for (int i = 0; i < jarray.length(); i++) {
                            ...
                            JSONObject jobj1 = jarray.getJSONObject(i);
                            txt_page_guideline.setText(Html.fromHtml(jobj1.getString("content")));
                        }
