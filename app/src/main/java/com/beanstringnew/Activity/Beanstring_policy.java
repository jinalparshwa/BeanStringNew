...
public class Beanstring_policy extends AppCompatActivity implements Thread.UncaughtExceptionHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beanstring_policy);
        ...
        txt_bean_policy = (TextView) findViewById(R.id.txt_bean_policy);
        imageView = (ImageView) findViewById(R.id.imageView);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Beanstring_policy.this, Home_Social.class);
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Beanstring_policy.this, Notification_activity.class);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Beanstring_policy.this, Search_activity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        drawer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Beanstring_policy.this, My_profile_activity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        llmybean.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Beanstring_policy.this, My_Beans_Activity_new.class);
                startActivity(intent);
                finish();
            }
        });
        Myapplication.getInstance().trackScreenView("Beanstring Policy Screen");
        beans_Count();
                ...
                try {
                    ...
                    if (res_flag.equals("200")) {
                        ...
                        for (int i = 0; i < jarray.length(); i++) {
                            ...
                            JSONObject jobj1 = jarray.getJSONObject(i);
                            txt_bean_policy.setText(Html.fromHtml(jobj1.getString("content")));
                        }
