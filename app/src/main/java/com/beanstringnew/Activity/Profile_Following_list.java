...
import com.beanstringnew.Adapter.Profile_following;
...
public class Profile_Following_list extends AppCompatActivity implements Thread.UncaughtExceptionHandler {

    GridView grid_profile_following;
    ...
    Profile_following adapter;
    String Userid;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_profile__following_list);
        context = this;
        ...
        get_state_city();
        grid_profile_following = (GridView) findViewById(R.id.grid_profile_following);
        adapter = new Profile_following(context, follower_array, api_c);
        grid_profile_following.setAdapter(adapter);
        Myapplication.getInstance().trackScreenView("Profile Following Screen");
    }
    ...
    private void HTTP_API_Following_list_Call() {
        ...
        final String url = Configr.app_url + "profilefollowinglist";
        ...
        String json_str = "";
        try {
            json_str = JSON.add_json(array_lll, pref, "profilefollowinglist");
        } catch (Exception e) {
            e.printStackTrace();
        }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status == 200) {
                        ...
                        DialogBox.alert_popup(context, res_message);
                    }
