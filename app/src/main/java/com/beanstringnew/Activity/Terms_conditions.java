...
public class Terms_conditions extends AppCompatActivity implements Thread.UncaughtExceptionHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Terms_conditions.this, Home_Social.class);
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Terms_conditions.this, Notification_activity.class);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Terms_conditions.this, Search_activity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        drawer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Terms_conditions.this, My_profile_activity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        llmybean.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Terms_conditions.this, My_Beans_Activity_new.class);
                startActivity(intent);
                finish();
            }
        });
        Myapplication.getInstance().trackScreenView("Terms and Condition Screen");
        beans_Count();
                ...
                try {
                    ...
                    if (res_flag.equals("200")) {
                        ...
                        for (int i = 0; i < jarray.length(); i++) {
                            ...
                            JSONObject jobj1 = jarray.getJSONObject(i);
                            txt_terms.setText(Html.fromHtml(jobj1.getString("content")));
                        }
