...
public class Sponsored_Photo_activity extends AppCompatActivity implements Thread.UncaughtExceptionHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sponsored__photo_activity);
        ...
        Glide.with(context).load(model.getUrl()).into(img1);
                        ...
                        switch (status) {
                            case "1": {
                                ...
                                ShareLinkContent shareLinkContent = new ShareLinkContent.Builder()
                                        ...
                                        //.setImageUrl(Configr.onShareItem(v_url, context))
                                        .build();
