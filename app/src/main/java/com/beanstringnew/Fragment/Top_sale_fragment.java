...
public class Top_sale_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.top_sale_fragment, container, false);
        context = getActivity();
        ...
        get_product();
        Myapplication.getInstance().trackScreenView("Top Sale Screen");
        return v;
    }
    ...
    public void get_product() {
        ...
        String url = Configr.app_url + "topsaleproduct";
        String json = "";
                ...
                try {
                    ...
                    if (res_flag.equals("200")) {
                        ...
                        for (int i = 0; i < jarray2.length(); i++) {
                            ...
                            // model.setPrice(jobj1.getString("price"));
