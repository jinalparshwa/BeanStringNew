...
import com.beanstringnew.Adapter.Adapter_other_profile_top_post;
...
public class Other_profile_top_post extends Fragment {

    Pref_Master pref;
    Context context;
    ListView list_latset;
    Activity_indicator obj_dialog;
    Adapter_other_profile_top_post adapter;
    ...
    public Other_profile_top_post(String Userid, Share share) {
        userid = Userid;
        this.share = share;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new Adapter_other_profile_top_post(context, array, pref, Other_profile_top_post.this);
        ...
        Myapplication.getInstance().trackScreenView("Other Profile Top Post Screen");
        return v;
...
//        obj_dialog.getWindow().setBackgroundDrawable(new ColorDrawable(0));
    ...
    public void latest_post_api() {
        ...
        String url = Configr.app_url + "profiletoppost";
        String json = "";

        json = JSON.add(array_j, pref, "profiletoppost");
