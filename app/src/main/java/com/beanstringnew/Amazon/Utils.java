package com.beanstringnew.Amazon;
...
/**
 * Created by Brinda on 6/19/2017.
 */
...
public class Utils {
    ...
    private static Pref_Master master;
    ...
    private static CognitoCachingCredentialsProvider getCredProvider(Context context) {
        master = new Pref_Master(context);

        if (sCredProvider == null) {

            sCredProvider = new CognitoCachingCredentialsProvider(
                    context.getApplicationContext(),
                    master.getStr_poolid(),
                    Regions.fromName(master.getStr_poolregion()));
        }
    ...
    public static AmazonS3Client getS3Client(Context context) {
        ...
        if (sS3Client == null) {
            ...
            sS3Client.setRegion(Region.getRegion(Regions.fromName(master.getStr_bucketregion())));
        }
        return sS3Client;
    }
