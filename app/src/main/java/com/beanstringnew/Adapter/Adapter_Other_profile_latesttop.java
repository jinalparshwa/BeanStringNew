...
/**
 * Created by Abc on 10/29/2016.
 */

public class Adapter_Other_profile_latesttop extends BaseAdapter {

    private final Context context;
    ArrayList<Model_profile> array;

    Pref_Master pref;

    LayoutInflater layoutInflater;
    ViewHolder holder;
    Other_profile_latestpost other_profile_latestpost;
    int value;
    Drawable perk_active, perk_like;
    String post_url = "";

    public Adapter_Other_profile_latesttop(Context context, ArrayList<Model_profile> array, Pref_Master pref, Other_profile_latestpost other_profile_latestpost) {
        super();
        this.context = context;
        this.array = array;
        this.pref = pref;
        this.other_profile_latestpost = other_profile_latestpost;
    ...
    public View getView(final int position, View v, ViewGroup parent) {
        ...
        final Model_profile model = array.get(position);

        if (v == null) {
            v = LayoutInflater.from(context).inflate(R.layout.other_row_latest_post_list, null);
        ...
        holder.lat_fname.setText(model.getFname());
        holder.lat_lname.setText(model.getLname());
        ...
        holder.comment_count.setText(model.getComment_count());
        ...
        if (model.getProfile().equals("")) {
            ...
            Glide.with(context).load(model.getProfile()).into(holder.lat_profile);
        }
        ...
        Log.e("vikas profile", ":" + model.getThumb());
            ...
            public void onClick(View view) {
                ...
                if (array.get(position).getMylike().equals("0")) {
                    ...
                    if (value == 1) {
                        ...
                        other_profile_latestpost.Likes(model.getPostid());
        ...
        holder.open_comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("post_id", model.getPostid());
        ...
        holder.img_share_bean.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                other_profile_latestpost.Check_share(model.getPostid(), model.getUserid(), "4", model.getDescription(), model.getThumb(), model.getStatus(), model.getUrl());
        ...
        holder.img_share_fb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (installed) {
                    if (!model.getStatus().equals("2")) {
                        getposturl(model.getPostid(), model.getUserid(), "1", model.getDescription(), model.getThumb(), model.getStatus(), model.getUrl());
        ...
        holder.img_share_gplus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (installed) {
                    getposturl(model.getPostid(), model.getUserid(), "2", model.getDescription(), model.getThumb(), model.getStatus(), model.getUrl());
                } else {
                    Toast.makeText(context, "App is not currently installed on your phone", Toast.LENGTH_LONG).show();
                }
            }
        ...
        holder.img_share_twitter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (installed) {
                    getposturl(model.getPostid(), model.getUserid(), "3", model.getDescription(), model.getThumb(), model.getStatus(), model.getUrl());
                } else {
                    Toast.makeText(context, "App is not currently installed on your phone", Toast.LENGTH_LONG).show();
                }
            }
                ...
                try {
                    ...
                    if (res_flag.equals("200")) {
                        ...
                        if (share_value.equals("1")) {
                            ...
                            other_profile_latestpost.Check_share(postid, userid, "1", description, thumb, status, post_url);
                        } else if (share_value.equals("2")) {
                            other_profile_latestpost.Check_share(postid, userid, "2", description, thumb, status, post_url);

                        } else if (share_value.equals("3")) {
                            other_profile_latestpost.Check_share(postid, userid, "3", description, thumb, status, post_url);
                        }
