...
public class AdapterFollowing_list extends BaseAdapter {
    ...
    ViewHolder holder;
    Runnable api_f;
    Followin_Fragment followin_fragment;
    int value;
    ...
    public AdapterFollowing_list(Context context, ArrayList<Model_user> array, Pref_Master pref, Followin_Fragment followin_fragment) {
        super();
        this.context = context;
        this.array = array;
        // this.api_f = api_f;
        this.pref = pref;
        this.followin_fragment = followin_fragment;
    ...
    public View getView(final int position, View v, ViewGroup parent) {
        ...
        if (v == null) {
            v = LayoutInflater.from(context).inflate(R.layout.row_following_post_list, null);
            holder.displayimage = (ImageView) v.findViewById(R.id.displayimage);
            holder.profilepic = (ImageView) v.findViewById(R.id.profilepic);
            holder.list_upload = (ImageView) v.findViewById(R.id.list_upload);
            holder.comment_image = (ImageView) v.findViewById(R.id.comment_image);
            ...
            holder.list_fname = (TextView) v.findViewById(R.id.list_fname);
            holder.list_lname = (TextView) v.findViewById(R.id.list_lname);
            holder.time = (TextView) v.findViewById(R.id.time);
            holder.list_post = (TextView) v.findViewById(R.id.list_post);
        ...
        if (model.getDescription().equals("")) {
            holder.list_post.setVisibility(View.GONE);
        } else {
            holder.list_post.setVisibility(View.VISIBLE);
        }
        ...
        holder.list_lname.setText(model.getLname());
        holder.list_post.setText(model.getDescription());
        holder.time.setText(model.getTime() + " ago");
        ...
        holder.list_fname.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        holder.list_lname.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(context, Other_Profile_activity.class);
                i.putExtra("id", model.getUserid());
        ...
        Log.e("Preference_image", pref.getStr_profile());

        if (pref.getStr_profile().equals("")) {

            holder.comment_image.setImageResource(R.drawable.default_imggg);
        } else {
            Glide.with(context).load(pref.getStr_profile()).into(holder.comment_image);
        }

        if (model.getPic().equals("")) {

            holder.profilepic.setImageResource(R.drawable.default_imggg);
        } else {
            Glide.with(context).load(model.getPic()).into(holder.profilepic);
        }
        ...
        if (model.getThumb().equals("")) {
            holder.list_upload.setImageResource(R.drawable.no_image);
            ...
            public void onClick(View view) {
                ...
                if (array.get(position).getMylike().equals("0")) {
                    ...
                    if (value == 1) {
                        ...
                        followin_fragment.Likes(model.getPost_id());
        ...
        holder.list_upload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        holder.img_share_bean.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                followin_fragment.Check_share(model.getPost_id(), model.getUserid(), "4", model.getDescription(), model.getThumb(), model.getStatus(), model.getUrl());
            }
        });
                ...
                try {
                    ...
                    if (res_flag.equals("200")) {
                        ...
                        if (share_value.equals("1")) {
                            ...
                            followin_fragment.Check_share(postid, userid, "1", description, thumb, status, post_url);
                        } else if (share_value.equals("2")) {
                            followin_fragment.Check_share(postid, userid, "2", description, thumb, status, post_url);

                        } else if (share_value.equals("3")) {
                            followin_fragment.Check_share(postid, userid, "3", description, thumb, status, post_url);
                        }
