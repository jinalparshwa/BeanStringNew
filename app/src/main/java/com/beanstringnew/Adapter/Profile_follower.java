...
public class Profile_follower extends BaseAdapter {
    ...
    public Profile_follower(Context context, ArrayList<Model_Follower_List> array, Runnable api_c) {
        super();
    ...
    public View getView(final int position, View v, ViewGroup parent) {
        ...
        if (v == null) {
            v = LayoutInflater.from(context).inflate(R.layout.row_layout_profile_follower, null);
