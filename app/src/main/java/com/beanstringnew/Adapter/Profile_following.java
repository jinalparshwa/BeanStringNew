...
public class Profile_following extends BaseAdapter {
    ...
    public Profile_following(Context context, ArrayList<Model_Follower_List> array, Runnable api_c) {
        super();
    ...
    public View getView(final int position, View v, ViewGroup parent) {
        ...
        if (v == null) {
            v = LayoutInflater.from(context).inflate(R.layout.row_layout_profile_following, null);
        ...
        Log.e("cityyy", model.getCity() + model.getState());
