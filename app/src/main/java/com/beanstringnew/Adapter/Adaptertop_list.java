...
public class Adaptertop_list extends BaseAdapter {
    ...
    ViewHolder holder;
    Top_Post_Fragment top_post_fragment;
    int value;
    ...
    public Adaptertop_list(Context context, ArrayList<Model_user> array, Pref_Master pref, Top_Post_Fragment top_post_fragment) {
        super();
        this.context = context;
        this.array = array;
        this.pref = pref;
        this.top_post_fragment = top_post_fragment;
    ...
    public View getView(final int position, View v, ViewGroup parent) {
        ...
        if (v == null) {
            v = layoutInflater.inflate(R.layout.row_top_post, null);

            holder.top_displayimage = (ImageView) v.findViewById(R.id.top_displayimage);
            holder.top_profile = (ImageView) v.findViewById(R.id.top_profile);
            holder.top_list_upload = (ImageView) v.findViewById(R.id.top_list_upload);
            holder.top_comment_image = (ImageView) v.findViewById(R.id.top_comment_image);
            ...
            holder.top_fname = (TextView) v.findViewById(R.id.top_fname);
            holder.lat_lname = (TextView) v.findViewById(R.id.lat_lname);
            holder.top_time = (TextView) v.findViewById(R.id.top_time);
            holder.top_post = (TextView) v.findViewById(R.id.top_post);
            holder.top_comment = (TextView) v.findViewById(R.id.top_comment);
            ...
            holder.lat_shared = (TextView) v.findViewById(R.id.lat_shared);
            holder.eps = (TextView) v.findViewById(R.id.eps);
            holder.lat_posttt = (TextView) v.findViewById(R.id.lat_posttt);
            ...
            holder.img_p = (ImageView) v.findViewById(R.id.img_p);
            holder.p_text = (ImageView) v.findViewById(R.id.p_text);
        ...
        if (model.getDescription().equals("")) {
            holder.top_post.setVisibility(View.GONE);
        } else {
            holder.top_post.setVisibility(View.VISIBLE);
        }

        if (model.getStatus().equals("0")) {
            holder.lat_posttt.setText("Photo");
        } else if (model.getStatus().equals("1")) {
            holder.lat_posttt.setText("Video");
        } else {
            holder.lat_posttt.setText("Post");
        }
        ...
        if (model.getStatus().equals("2")) {
            ...
            holder.p_text.setVisibility(View.VISIBLE);
        } else {
            holder.p_text.setVisibility(View.GONE);
            holder.rr_lat.setVisibility(View.VISIBLE);
            holder.ll_beans.setVisibility(View.GONE);
        }


        if (model.getSstatus().equals("1")) {
            holder.top_fname.setText(model.getFname() + " " + model.getLname());
            holder.lat_lname.setVisibility(View.GONE);
            holder.lat_shared.setVisibility(View.GONE);
            holder.lat_posttt.setVisibility(View.GONE);
            holder.eps.setVisibility(View.GONE);
            holder.img_p.setVisibility(View.GONE);
        } else {
            holder.top_fname.setText(model.getSfname() + " " + model.getSlname());
            holder.lat_lname.setVisibility(View.VISIBLE);
            holder.lat_lname.setText(model.getFname() + " " + model.getLname());
            holder.lat_shared.setVisibility(View.VISIBLE);
            holder.lat_posttt.setVisibility(View.VISIBLE);
            holder.eps.setVisibility(View.VISIBLE);
            holder.img_p.setVisibility(View.VISIBLE);
        }
        holder.top_post.setText(model.getDescription());
        holder.top_time.setText(model.getTime() + " ago");
        ...
        try {
            ...
            if (model.getComments().size() != 0) {
                ...
                Log.e("huhdsufczh", "" + model.getComments().size());
                holder.ll_first.setVisibility(View.GONE);
                holder.ll_second.setVisibility(View.GONE);
                holder.ll_third.setVisibility(View.GONE);
            }
        ...
        if (pref.getStr_profile().equals("")) {
            holder.top_comment_image.setImageResource(R.drawable.default_imggg);

        } else {
            Glide.with(context).load(pref.getStr_profile()).into(holder.top_comment_image);
        }

        if (model.getPic().equals("")) {
            holder.top_profile.setImageResource(R.drawable.default_imggg);

        } else {
            Glide.with(context).load(model.getPic()).into(holder.top_profile);
        }

        Log.e("profile", ":" + model.getThumb());
        holder.top_fname.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (model.getSstatus().equals("1")) {
                    ...
                    Intent i = new Intent(context, Other_Profile_activity.class);
                    i.putExtra("id", model.getSsuerid());
                    context.startActivity(i);
                }
            }
        });
        holder.lat_lname.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (model.getSstatus().equals("1")) {
                    Intent i = new Intent(context, Other_Profile_activity.class);
        ...
        holder.top_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (model.getSstatus().equals("1")) {
                    Intent i = new Intent(context, Other_Profile_activity.class);
        ...
        if (model.getThumb().equals("")) {
            holder.top_list_upload.setImageResource(R.drawable.no_image);
            ...
            public void onClick(View view) {
                ...
                if (array.get(position).getMylike().equals("0")) {
                    ...
                    if (value == 1) {
                        ...
                        top_post_fragment.Likes(model.getPost_id());
        ...
        holder.top_list_upload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (model.getStatus().equals("0")) {
        ...
        holder.top_comment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        holder.img_share_bean.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                top_post_fragment.Check_share(model.getPost_id(), model.getUserid(), "4", model.getDescription(), model.getThumb(), model.getStatus(), model.getUrl());
            }
        });
    ...
    private class ViewHolder {
        ...
        ImageView top_list_upload;
        ImageView top_displayimage;
        ImageView top_comment_image;
                ...
                try {
                    ...
                    if (res_flag.equals("200")) {
                        ...
                        if (share_value.equals("1")) {
                            ...
                            top_post_fragment.Check_share(postid, userid, "1", description, thumb, status, post_url);
                        } else if (share_value.equals("2")) {
                            top_post_fragment.Check_share(postid, userid, "2", description, thumb, status, post_url);

                        } else if (share_value.equals("3")) {
                            top_post_fragment.Check_share(postid, userid, "3", description, thumb, status, post_url);
                        }
