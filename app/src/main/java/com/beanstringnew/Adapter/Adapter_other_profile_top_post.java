...
public class Adapter_other_profile_top_post extends BaseAdapter {
    ...
    ViewHolder holder;
    Other_profile_top_post other_profile_top_post;
    int value;
    Drawable perk_active, perk_like;
    String post_url = "";


    public Adapter_other_profile_top_post(Context context, ArrayList<Model_profile> array, Pref_Master pref, Other_profile_top_post other_profile_top_post) {
        super();
        this.context = context;
        this.array = array;
        this.pref = pref;
        this.other_profile_top_post = other_profile_top_post;
    ...
    public View getView(final int position, View v, ViewGroup parent) {
        ...
        if (v == null) {
            v = LayoutInflater.from(context).inflate(R.layout.other_row_top_post_list, null);
            ...
            public void onClick(View view) {
                ...
                if (array.get(position).getMylike().equals("0")) {
                    ...
                    if (value == 1) {
                        ...
                        other_profile_top_post.Likes(model.getPostid());
        ...
        holder.img_share_bean.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                other_profile_top_post.Check_share(model.getPostid(), model.getUserid(), "4", model.getDescription(), model.getThumb(), model.getStatus(), model.getUrl());
                ...
                try {
                    ...
                    if (res_flag.equals("200")) {
                        ...
                        if (share_value.equals("1")) {
                            ...
                            other_profile_top_post.Check_share(postid, userid, "1", description, thumb, status, post_url);
                        } else if (share_value.equals("2")) {
                            other_profile_top_post.Check_share(postid, userid, "2", description, thumb, status, post_url);

                        } else if (share_value.equals("3")) {
                            other_profile_top_post.Check_share(postid, userid, "3", description, thumb, status, post_url);
                        }
